...
const ChatLabel = ({ openMenu, setOpenMenu }) => {
    return (
        <div className='flex item-center justify-between p-2 text-white/80 hover:bg-gray-700 rounded-lg text-sm group cursor-pointer'>
            <p className='group-hover:max-5/6 truncate'>Chat Name</p>
            <div className='group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/80 rounded-lg'>
                ...
                <div className={`absolute ${openMenu.open ? 'block' : 'hidden'} -right-30 top-6 bg-gray-700 rounded-xl w-max p-2`}>
